...
LINK_UFF_DIR = SCRIPT_DIR.parent
CODIGOS_DIR = LINK_UFF_DIR.parent
for directory in (LINK_UFF_DIR, CODIGOS_DIR):
...
def run_session(args: argparse.Namespace) -> Path:
    ...
    from controle.alvo_alinhamento import roi_incluindo_alvo
    from controle.cameras.backend import direct_camera
