...
```powershell
# Ensaio de uma hora
python ".\Link UFF\caracterizacao_beacon\caracterizar_beacon_ids.py" --minutes 60

# Executar ate Q, Esc ou Ctrl+C
python ".\Link UFF\caracterizacao_beacon\caracterizar_beacon_ids.py" --minutes 0

# Usar ROI maior
python ".\Link UFF\caracterizacao_beacon\caracterizar_beacon_ids.py" --minutes 30 --roi 640
```

Os parametros de exposicao, FPS e ganho continuam centralizados em
`Link UFF/config_camera_ids.py`.
