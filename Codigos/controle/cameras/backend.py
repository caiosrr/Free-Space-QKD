...
def _zwo_camera():
    from controle.cameras.zwo_sdk import camera
...
def connect_camera() -> None:
    if backend_name() in {"ids", "zwo_sdk"}:
        ...
        return
    from controle.cameras.alpaca import connect
...
def disconnect_camera() -> None:
    if backend_name() in {"ids", "zwo_sdk"}:
        ...
        return
    from controle.cameras.alpaca import disconnect
...
def set_gain(gain: float) -> None:
    ...
    if backend_name() == "zwo_sdk":
        ...
        return
    from controle.cameras.alpaca import set_gain as alpaca_set_gain
